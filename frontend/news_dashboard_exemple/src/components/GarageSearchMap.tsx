...
const GarageSearchMap: React.FC<GarageSearchMapProps> = ({ 
  vehicleInfo, 
  selectedService, 
  ...
  const handleReserve = (garage: Garage) => {
    toast.success(`Réservation en cours chez ${garage.name} pour ${selectedService}`);
  };
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
          ...
          {filteredGarages.length} garage(s) trouvé(s) pour "{selectedService}"
        </h2>
      </div>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-500">pour {selectedService}</p>
                </div>
              </div>
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            <span>Prix:</span>
                            <span className="font-bold text-green-600">{garage.priceForService}€</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Distance:</span>
...
export default GarageSearchMap;
